registerBlockType( 'childress/price-boxes', {
    title: 'Price Boxes',
    ...
    edit( { attributes, className, setAttributes } ) {
        return (
            <section className={ className + ' price-boxes' }>
                <InnerBlocks
                    allowedBlocks={['childress/price-box']}
                    template={[
                        ['childress/price-box'],
                        ['childress/price-box'],
                        ['childress/price-box'],
    ...
    save( { attributes } ) {
        return (
            <section className='price-boxes container'>
                <InnerBlocks.Content />
            </section>
        );
    },
...
registerBlockType( 'childress/price-box', {
    title: 'Price Box',
    icon: createElement('svg', 
        { 
            width: 59.997,
    ...
    edit( { attributes, className, setAttributes } ) {
        const { title, price, priceSubtitle } = attributes;

        return (
            <section className={ className + ' price-box' }>
                ...
                <div className='price-box__price-wrapper'>
                    ...
                    <p className='price-box__price-subtitle'>
                        <PlainText
                            value={ priceSubtitle }
                            onChange={ ( value ) => { setAttributes({ priceSubtitle: value }) } }
    ...
    save( { attributes } ) {
        ...
        return (
            <section className='price-box'>
                <h3 className='price-box__title'>{ title }</h3>
                <div className='price-box__price-wrapper'>
                    <p className='price-box__price'><sup>$</sup>{ price }</p>
                    <p className='price-box__price-subtitle'>{ priceSubtitle }</p>
                </div>
                <div className='price-box__list'>
                    <InnerBlocks.Content />
                </div>
